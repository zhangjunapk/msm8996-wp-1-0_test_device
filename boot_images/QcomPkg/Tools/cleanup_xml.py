...
#==============================================================================================
# Main function that preprocesses system xml and directory
#==============================================================================================   
def preprocess_system_dir(Input_PathDir, Output_ImageXMLFileName, Input_SystemXMLFileName, Input_ModuleName):
   ...
   for filename in os.listdir(Input_PathDir):
    if filename.endswith('.xml'):
     if filename == os.path.basename(Input_SystemXMLFileName):
      ...
      out_xml_fp.write("#include \"" + Input_PathDir + "/" + filename + "\"\n")
...
def main():
   ...
   if options.xml_input is not None:
      ...
      preprocess_system_dir(Input_PathDir, Output_ImageXMLFileName, Input_SystemXMLFileName, Input_ModuleName)
   return   
