    ...
    def sign_hash(self, hash_to_sign, imageinfo, binary_to_sign=None,
        ...
        if root_certificate_params_is_valid:
            if generate_new_root_certificate:
                ...
                root_cert, root_key_pair = crypto_functions.create_root_certficate(root_certificate_params, generated_root_key_pair, 7300, openssl_configfile, 1, use_pss)
            else:
        ...
        if attestation_certificate_params_is_valid:
            ...
            signature = crypto_functions.encrypt_with_private_key(hash_to_sign, attestation_certificate_key_pair['private_key'], use_pss)
        else:
