...
class RemoteSigner(BaseSigner):
    ...
    def sign_hash(self, hash_to_sign, imageinfo, binary_to_sign, debug_dir=None, sha_algo=None):
        ...
        try:
            ...
            is_hmac = imageinfo.general_properties.hmac.lower() == 'true'
            use_pss = imageinfo.general_properties.rsa_padding.lower() == 'pss'
            if self.validate_sig(binary_to_sign, signature, cert_chain_list, 'qcom_hmac' if is_hmac else 'sha256', use_pss) is False:
