...
/**
   @brief
   Check if buffers or sessions have changed while in HLOS.
...
/**
   @brief
   Get a secure buffer tagged as an application buffer.

   The buffer is allocated in HLOS.
...
/**
   @brief
   Free a buffer previously allocated with #sec_ui_alloc_app_buffer.

   This function requests the HLOS to free the ION memory that was allocated
