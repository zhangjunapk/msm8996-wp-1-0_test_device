...
/*===========================================================================
  ...
  $Header: //components/rel/core.tz/1.0.3.c1/securemsm/sse/qsee/SecureDisplay/libgd/include/gd.h#1 $
...
#define gdAlphaMax 255U
#define gdAlphaOpaque 255U
#define gdAlphaTransparent 0
#define gdRedMax 255U
#define gdGreenMax 255U
#define gdBlueMax 255U
...
BGD_DECLARE(unsigned int) gdGetMaxLenForWidth (gdFontPtrExt f, unsigned char *s, unsigned int len, unsigned int max_width);
...
BGD_DECLARE(int) getUnicode(unsigned char *s);
