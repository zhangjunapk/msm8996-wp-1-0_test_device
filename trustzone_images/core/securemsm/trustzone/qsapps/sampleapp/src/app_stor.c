...
/*===========================================================================
  ...
  $Header: //components/rel/core.tz/1.0.3.c1/securemsm/trustzone/qsapps/sampleapp/src/app_stor.c#1 $
...
int run_stor_test()
{
  ...
  // Remove the partition used for testing 
  retVal = qsee_stor_remove_client(&gClientHandle); 
  if( retVal != 0 )
  {
	return 1;
  }
