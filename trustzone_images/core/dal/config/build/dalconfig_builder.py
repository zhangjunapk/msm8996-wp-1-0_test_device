...
#    DAL config builder
#
# Copyright (c) 2009-2009, 2014 Qualcomm Technologies, Inc.
# All Rights Reserved.
# QUALCOMM Proprietary/GTDR
#
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.tz/1.0.3.c1/dal/config/build/dalconfig_builder.py#1 $
...
# 12/22/14   sg      cleanup_xml functionality converted to python.
# 10/31/14   aa      Generation of DALModDir_xx.c and DALConfig_xx is separated.
...
def DALConfig_src_builder(target, source, env):
   ...
   cmds = [
      ...
      propgen_root_cmd + ' --XmlFile=' + clean_xml + ' --DirName=' + target_path + ' --ConfigFile=' + target_config_full + ' --DevcfgDataFile=' + target_devcfgdata_full + ' --ConfigType=' + env['CONFIG'] + ' --RemoveDups=True'
   ]
